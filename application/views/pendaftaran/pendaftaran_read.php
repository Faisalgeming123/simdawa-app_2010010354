            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?= base_url('pendaftaran/daftar') ?>" class="btn btn-sm btn-success floatright"><i class="fas fa-plus">Tambah Data</i></a>
                        <a href="<?= base_url('pendaftaran/cetak') ?>" class="btn btn-sm btn-info mr-1 floatright"><i class="fas fa-print">Cetak Data</i></a>
                    </div>
                    <div class="card-body">
